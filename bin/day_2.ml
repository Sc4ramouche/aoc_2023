...
let check_color color limit str =
...
let process acc line =
  try
    ...
    let red_possible = check_color "red" 12 line in
    let green_possible = check_color "green" 13 line in
    let blue_possible = check_color "blue" 14 line in
